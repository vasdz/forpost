...
в карточке сработки нажмите «Войти как диспетчер ОДС». Сессия действует 5 минут.
...
Последняя команда читает готовый processed-снимок через настоящий FastAPI
в одном процессе ASGI: 20 конкурентных сессий, 100 GET-запросов к topology и

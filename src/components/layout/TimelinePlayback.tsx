...
export function TimelinePlayback() {
  ...
  return <footer aria-label="Воспроизведение временной шкалы" className="surface-subtle fixed bottom-0 left-[var(--active-sidebar-width)] right-0 z-30 grid h-[var(--timeline-height)] grid-cols-[auto_auto_minmax(200px,1fr)_auto] items-center gap-4 overflow-x-auto rounded-none border-x-0 border-b-0 px-4 py-3 md:px-6">

...
import { Activity, BellRing, Building2, ClipboardList, FileStack, Flame, LayoutDashboard, Menu, Network, Settings, ShieldAlert, Wrench } from 'lucide-react';
...
const navigation: NavigationItem[] = [
  { href: '/', label: 'Обзор', icon: LayoutDashboard }, { href: '/notifications', label: 'Уведомления', icon: BellRing }, { href: '/sensor-failure', label: 'Отказ датчика', icon: Activity }, { href: '/fire-risk', label: 'Пожарный риск', icon: Flame }, { href: '/unauthorized-access', label: 'Несанкционированный доступ', icon: ShieldAlert }, { href: '/infrastructure-wear', label: 'Износ инфраструктуры', icon: Building2 }, { href: '/topology', label: 'Схема объектов', icon: Network }, { href: '/registries', label: 'Реестры', icon: FileStack }, { href: '/journals', label: 'Журналы', icon: ClipboardList }, { href: '/applications', label: 'Заявки', icon: Wrench }, { href: '/design-system', label: 'Настройки', icon: Settings },
];
